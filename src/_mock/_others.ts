...
export const _socials = [
  {
    value: 'instagram',
    label: 'Instagram',
    pathW3W: 'https://www.instagram.com/web3_wanderers',
    pathBFS: 'https://www.instagram.com/blockforgesolutions/',
  ...
  },
  {
    value: 'linkedin',
    label: 'Linkedin',
    pathW3W: 'https://www.linkedin.com/company/web3-wanderers/',
    pathBFS:"https://www.linkedin.com/company/blockforge-solutions",
  ...
  },
  {
    value: 'twitter',
    label: 'Twitter',
    pathW3W: 'https://x.com/web3wanderers1',
    pathBFS: 'https://x.com/web3wanderers1',
  ...
  },
  {
    value: 'youtube',
    label: 'Youtube',
    pathW3W: 'https://www.youtube.com/@Web3Wanderer',
    pathBFS: 'https://www.youtube.com/@Web3Wanderer',
